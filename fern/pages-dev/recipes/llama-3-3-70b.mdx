...
All three targets serve `RedHatAI/Llama-3.3-70B-Instruct-FP8-dynamic` on the vLLM runtime (`nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.3.0`) and are benchmarked at 16 concurrency per GPU with 8K ISL / 1K OSL traffic:
