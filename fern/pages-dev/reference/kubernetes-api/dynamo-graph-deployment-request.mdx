...
<ParamField path="image" type="string">
  Container image for the profiling job (the planner image), for example `nvcr.io/nvidia/ai-dynamo/dynamo-planner:1.4.2`. For Dynamo < 1.1.0, use `dynamo-frontend`.
</ParamField>
