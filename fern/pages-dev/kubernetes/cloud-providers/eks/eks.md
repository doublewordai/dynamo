...
export DYNAMO_RELEASE_VERSION="1.3.0"
```
...
It targets `g7e.12xlarge` instances, which support GPUDirect RDMA, and uses the multi-arch Dynamo EFA-enabled vLLM container `nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.3.0-efa` that ships with the [EFA Installer](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-changelog.html) pre-installed.
