...
```bash
sed \
  -e "s|nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.4.2|nvcr.io/nvidia/ai-dynamo/vllm-runtime:${DYNAMO_VERSION}|g" \
  -e "s|nvcr.io/nvidia/ai-dynamo/vllm-runtime-xpu:1.4.0|${XPU_IMAGE}|g" \
