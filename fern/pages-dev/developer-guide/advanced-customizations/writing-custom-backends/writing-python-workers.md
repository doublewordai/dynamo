...
For more information about how request migration works, see the [Request Migration Architecture](../../../kubernetes/fault-tolerance/request-migration.md) documentation.
...
For detailed information about request cancellation, including async cancellation monitoring and context propagation patterns, see the [Request Cancellation Architecture](../../knowledge-base/concepts/fault-tolerance/request-cancellation-architecture.md) documentation.
