...
For quick start instructions, see the [Router README](overview.md). This document provides further examples for using the Dynamo Router, including Python API usage, Kubernetes deployments, and custom routing patterns.
...
- [Kubernetes deployment guide](../../../../kubernetes/getting-started/quickstart.mdx)

**For A/B Testing and Advanced K8s Setup:**
See the comprehensive [KV Router A/B Benchmarking Guide](../../../../recipes/feature-benchmarks/kv-router-a-b-testing.md) for step-by-step instructions on deploying, configuring, and benchmarking the KV router in Kubernetes.
...
For full documentation on implementing KV event publishing for custom inference engines, see the dedicated [KV Event Publishing for Custom Engines](../../../advanced-customizations/writing-custom-backends/publish-kv-events.md) guide. It covers:
