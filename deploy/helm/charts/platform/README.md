...
|------------|------|---------|
| file://components/operator | dynamo-operator | 1.4.2 |
...
| dynamo-operator.controllerManager.manager.image.tag | string | `"1.4.2"` | Image tag (leave empty to use chart default) |
