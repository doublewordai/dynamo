...
def test_coalesces_tool_call_deltas_into_finish_chunk():
    coalescer = _ToolCallCoalescer()
...
def test_passes_through_terminal_usage_chunk_with_empty_choices():
    coalescer = _ToolCallCoalescer()
...
def test_preserves_usage_attached_to_a_fully_buffered_delta_chunk():
    coalescer = _ToolCallCoalescer()
...
def test_drops_fully_buffered_delta_chunks_without_usage():
    coalescer = _ToolCallCoalescer()
