...
use super::{SessionAffinityMode, replica_sync::ReplicaSyncRuntime};
use crate::{
...
impl AffinityCoordinator {
    ...
    pub(crate) fn enable_scale_up(&self, tracker: super::ScaleUpMigrationTracker) {
        self.inner.table.enable_scale_up(tracker);
    }
    ...
    pub(crate) fn commit_to_stream<U: Data>(
        &self,
        hold: Hold,
...
pub(super) fn tracked_stream<U: Data>(lease: AffinityLease, stream: ManyOut<U>) -> ManyOut<U> {
